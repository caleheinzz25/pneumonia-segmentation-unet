  ...
  \begin{column}{0.48\textwidth}
    \begin{block}{\footnotesize Beban Klinis \& Keterbatasan Diagnosis Manual}
      \begin{itemize}\scriptsize
        \item \textbf{Mortalitas Tinggi}: Pneumonia merenggut $\sim$\,2,5 juta jiwa global tahun 2019 (WHO), dengan korban terbesar anak di bawah 5 tahun \& lansia \parencite{who2022}.
  ...
  \begin{column}{0.48\textwidth}
    ...
    \begin{block}{\footnotesize Keunggulan CNN pada Segmentasi Medis}
      \begin{itemize}\tiny
        ...
        \item \textbf{Pretrained Backbone}: Menjadi fondasi *Feature Extractor* pada arsitektur U-Net (EfficientNet-B3).
      \end{itemize}
    \end{block}
  \end{column}
\end{columns}
...
% ─── SLIDE 9: HASIL EVALUASI KUANTITATIF & CONFUSION MATRIX ─
\begin{frame}{HASIL EVALUASI KUANTITATIF \& CONFUSION MATRIX}{Evaluasi Performa Segmentasi pada Data Validasi (350.224.384 Total Piksel)}
\begin{columns}[T]
...
% ─── SLIDE 14: TAMPILAN WEBSITE & CLOUDFLARE TUNNEL ─────────
...
% ─── SLIDE 14: KESIMPULAN ───────────────────────────────────
\begin{frame}{KESIMPULAN}{Sintesis Capaian Penelitian Berdasarkan Tujuan \& Pengujian}
